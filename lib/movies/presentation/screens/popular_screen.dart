...
class PopularMoviesScreen extends StatelessWidget {
  ...
  static String popularScreenId = 'PopularScreenId';

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => PopularCubit(sl())..getPopularMovies(),
        ...
        builder: (context, state) {
          ...
          return Scaffold(
            ...
            body: ConditionalBuilder(
                condition: cubit.popularMoviesList.isNotEmpty,
                            ...
                            onTap: () {
                              Navigator.pushNamed(
                                  ...
                                  arguments: DetailScreenArgument(
                                      cubit.popularMoviesList[index].id));
                            },
                            child: Card(
                              child: Padding(
                                            ...
                                            children: [
                                              ...
                                              Row(
                                                children: [
                                                  ...
                                                  const SizedBox(width: 4.0),
                                                  Text(
                                                    '(${cubit.popularMoviesList[index].voteAverage})',
                                                    style: const TextStyle(
                                                      fontSize: 1.0,
                                                      fontWeight:
                                                          FontWeight.w500,
